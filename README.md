...
| **threedsAuthenticationValue** (optional/required)    | string  | A digital signature that proves that the transaction has been 3DS verified. <br>**The threedsAuthenticationValue parameter is required for 3DS version 2.1.0**.                                            |
